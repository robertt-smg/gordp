...
import (
	...
	"github.com/robertt-smg/gordp/plugin"

	"github.com/robertt-smg/gordp/glog"

	"github.com/lunixbochs/struc"
	"github.com/robertt-smg/gordp/core"
	"github.com/robertt-smg/gordp/protocol/t125/per"
)
...
type X509CertificateChain struct {
	...
	//we don't care and it can cause error if 0 size
	// ' unpack `Padding`  is a slice with no length or sizeof field ...
